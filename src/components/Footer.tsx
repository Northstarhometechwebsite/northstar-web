        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div>
            <div className="mb-6">
              ...
              <br />
              <span className="font-body text-[9px] font-semibold tracking-[0.2em] uppercase text-cream/50">
                HOME TECHNOLOGIES
              </span>
            </div>
            <div className="gold-rule mb-6" />
            <div className="space-y-1 text-[13px] text-cream/50">
          ...
          {/* Navigation */}
          <div>
            <h4 className="font-body text-[11px] font-semibold uppercase tracking-[0.15em] text-warm-gold mb-6">
              Navigation
            </h4>
            <nav className="flex flex-col gap-3">
              {FOOTER_LINKS.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="font-body text-[14px] text-cream/50 hover:text-warm-gold transition-colors duration-300"
                >
                  {link.label}
                </Link>
              ))}
            ...
            <div className="space-y-3 text-[14px]">
              <p>
                <a
                  ...
                  className="text-cream/50 hover:text-warm-gold transition-colors"
                >
                  {COMPANY.phone}
                </a>
              </p>
              ...
              <p className="text-cream/30 text-[13px] mt-4">{COMPANY.hours}</p>
            </div>
          </div>
        </div>
      </div>
