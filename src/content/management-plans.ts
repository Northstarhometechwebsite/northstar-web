...
export const managementPlans: ManagementPlan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Daytime & Saturday on-site support: $125/hour (no minimum)" },
      { text: "After-hours/Sunday on-site support: $200/hour (no minimum)" },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Sunday on-site support: $200/hour (no truck roll fee)" },
